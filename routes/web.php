...
Route::group(['middleware' => ['auth']], function(){
    ...
    Route::get('/all-services', 'ShopSettingController@allServices')->name('.all-services');
        ...
        Route::get('/view-oil-service/{vinid?}', 'OilServicesController@viewoilIndex')->name('.view-oil-service');
    ...
    //    Route::post('/save-OilServices', 'OilServicesController@save_oilservices')->name('.save-OilServices');
       Route::post('/save-OilServices', 'OilServicesController@save_oilservices_custom')->name('.save-OilServices');
