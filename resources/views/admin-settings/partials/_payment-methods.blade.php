<div class="account-settings__content account-settings__content-payment {{ $tab == 'paymentMethods' ? 'account-settings__content--active' : '' }} settings-form" id="paymentMethods">
