                    ...
                    <div class="create-your-account__by-email sign-email">
                        ...
                        <div class="sign-email__tabs-content">
                            <div class="sign-email__tab-content">
                                <form class="sign-email__form {{ $type == 'register' ? 'sign-email__form--active' : '' }}" id="loginForm" method="POST" action="{{ route('register') }}">
                                    @csrf
                                    <input type="hidden" id="ctrole" name="ctrole" value="3">
                                    ...
                                    <div class="sign-email__fields">
                                        ...
                                        <div class="sign-email__field custom-input custom-input--password custom-input--default fv-row">
                                            <div class="custom-input__field-wr">
                                                <input class="custom-input__field signupPassword" id="signupPassword" type="password" name="password" autocomplete="off" placeholder="Create password"/>
                                        ...
                                        <div class="sign-email__field custom-input custom-input--password custom-input--default fv-row">
                                            ...
                                            <div class="fv-plugins-message-container"><div  class="fv-help-block usermismatcherror" id="usermismatcherror" ></div></div>
                                        </div>
                                    ...
                                    </div><button class="sign-email__submit btn btn--accent" id="kt_login_submit" type="submit">Sign Up</button>
                                    {{-- <a class="sign-email__forgot link link--full-accent" href="{{route('password.request')}}">Forgot
                                        password?</a> --}}
                                </form>
