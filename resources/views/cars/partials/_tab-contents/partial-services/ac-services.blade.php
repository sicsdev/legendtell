            ...
            <div class="row">
               <div class="col-12 col-md-6 image">
                  ...
                  <video width="320" height="240" controls>
                     <source class="videos" src="{{$car->medias_picture->filename}}" type="video/mp4">
                     <source class="videos" src="{{$car->medias_picture->filename}}" type="video/ogg">
                  ...
                  @if($car->medias_picture && $car->medias_picture->filename)
                  @if($car->medias_picture->type == "image")
                  <img class="w-100 images" src="{{$car->medias_picture->filename}}">
                  @else
                  <video width="320" height="240" controls>
                     <source class="videos" src="{{$car->medias_picture->filename}}" type="video/mp4">
                     <source class="videos" src="{{$car->medias_picture->filename}}" type="video/ogg">
               ...
               <div class="col-12 col-md-6">
                  <ul class="desc-wrap">
                     ...
                     <li class="cmn-serve-title">{{ $car->milage ?? ''}} Mileage</li>
                  </ul>
               </div>
            </div>
            <div class="row mt-5">
