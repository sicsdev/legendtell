...
<main class="page-wrapper">
               ...
               <ul class="slider-container">
                  ...
                  <li>
                     <div class="shop-content-wrap view-shop-slider">
                        ...
                        <div class="shop-logo">
                           @if($carslide['shop_user'] && $carslide['shop_user']['avatar'])
                           <img src="{{$carslide['shop_user']['avatar']}}">
                           @else
                           <img src="{{ asset('/assets/images/image-empty-state.jpg') }}">
                           @endif
                        </div></a>
                        <?php
   ...
   <div class="row border-bb">
      ...
      <?php //echo "<pre>"; print_r(json_decode($CarData->vehicle_data)); die; 
      ?>

      @if($CarData->vehicle_type == '18-Wheeler Cab')
      ...
      @endif
      @if($CarData->vehicle_type == 'Camper - Large')
