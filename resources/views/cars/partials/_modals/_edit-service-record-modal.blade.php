<div class="modal modal--add-car modal--default" id="editServiceRecordModal">
    <div class="modal__inner">
      ...
      <h4 class="modal__title">Edit Service Record</h4>
      ...
      <form id="editCarServiceModal" method="POST" action="{{route('car.edit-service', $car->id)}}">
        @csrf
        ...
        <div class="modal__service-btns">
          <button class="modal__service-btn btn btn--accent" id="editServiceRecordBtn" type="submit">
            Save Record</button><button class="modal__service-btn btn btn--accent-border" id="editServiceRecordCancel"
            type="button">
            Cancel
          </button>
        </div>
