    <div class="content-tab" id="editVin">
      <section class="service-history">
         ...
         <div class="form-box">
           ...
           <div class="form-group">
            <div class="row d-flex align-items-center">
              <div class="col-lg-4 col-12">
              <span class="label-title">
                <label>Date of Service:<span class="astrick">*</span></label>
               </span>
              </div>
              <div class="col-lg-8 col-12">
               <span class="input-wrap">
                <input type="date" class="form-control date_of_service"  id="edit_date_of_service" name="date_of_service">
                <span class="errorShow date_of_service_error" id="date_of_service_error"></span>
        ...
        <div class="d-flex">
          ...
          <button class="car-adding__btn btn  btn-info btn--accent" id="view_vin_detail" type="button">View</button>
