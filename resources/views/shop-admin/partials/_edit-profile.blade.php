<form class="account-settings__content account-settings__content-form account-settings__content--active settings-form"
    ...
    <div class="settings-form__inner">
        <div class="settings-form__avatar account-avatar fv-row">
            <div class="account-avatar__photo-wr">
                <img class="account-avatar__img avatarImg" id="avatarImg" src="{{auth()->user()->avatar_url}}" alt="alt" />
            </div>
            ...
            <div class="type-box">
                ...
                <ul>
                    <li>
                        <a href="#">Detailing shop</a>
                    </li>
                    <li>
                        <a href="#">PPF Shop</a>
                    </li>
                    <li>
                        <a href="#">Vinyl Wrap Shop</a>
                    </li>
                </ul>
        ...
        <div class="settings-form__fields">
            <div class="settings-form__changes-saved changes-saved" id="changesSaved">
                ...
                <shapn class="changes-saved__text">Changes saved!</shapn>
            </div>
            <div class="
            custom-input
            ...
            ">
                <label class="custom-input__label" for="name">Shop/Location Name</label>
                <div class="custom-input__field-wr fv-row">
                    <input class="custom-input__field" id="name" type="name" name="name" placeholder="User Name" value="{{ auth()->user()->name }}" required />
                </div>
            </div>
            <div class="
            custom-input
            ...
            ">
                <label class="custom-input__label" for="firstName">Contact First name*</label>
                <div class="custom-input__field-wr fv-row">
            ...
            ">
                <label class="custom-input__label" for="lastName">Contact Last name*</label>
                <div class="custom-input__field-wr fv-row">
            ...
            ">
                ...
                <div class="custom-input__field-wr fv-row">
                    <input class="custom-input__field custom-input__field--number" id="zipCode" name="zip_code" type="number" placeholder="Zip Code" value="{{auth()->user()->zip_code}}" required />
                </div>
            </div>
            <div class="
            custom-input
            ...
            ">
                ...
                <div class="custom-input__field-wr fv-row">
                    <input class="custom-input__field" id="country" name="country" type="text" placeholder="United States" value="{{auth()->user()->country}}" required />
                </div>
            </div>
